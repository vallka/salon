...
class Appointment(models.Model):
    ...
    status = models.PositiveIntegerField(choices=Status.choices, default=Status.SCHEDULED)

    tips = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    paid_deposit = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    paid_cash = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    paid_card = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    paid_bank = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    paid_paypal = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
